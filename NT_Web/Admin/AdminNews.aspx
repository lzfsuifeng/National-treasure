...
<body>
    ...
    <div>
         <div class="top-title">
         <asp:Label ID="Label4" runat="server" Text="前世今生管理" Font-Size="15" Font-Names="微软雅黑"></asp:Label>
    </div>
    <table class="table" style="border-collapse:separate; border-spacing:0px 20px; ">
            ...
            <tr class="tr2">
                    ...
                    <td ><asp:Label ID="acttime" runat="server" Text='<%#SplitChar(Eval("News_Content").ToString(),10)%>'></asp:Label></td>     
