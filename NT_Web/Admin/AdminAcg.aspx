...
<body>
    ...
    <table class="table" style="border-collapse:separate; border-spacing:0px 20px; ">
            ...
            <tr class="tr2">
                    ...
                    <td ><asp:Label ID="endtime" runat="server" Text='<%#Eval("Tally_Name") %>'></asp:Label></td>
                    <td ><asp:Label ID="Label1" runat="server" Text='<%#Eval("Pro_Class") %>'></asp:Label></td>              
                    <td>
