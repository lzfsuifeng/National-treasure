<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAction.aspx.cs" Inherits="NT_Web.Admin.AdminAction" %>
...
<body>
    ...
    <div>
         <div class="top-title">
         <asp:Label ID="Label4" runat="server" Text="活动管理" Font-Size="15" Font-Names="微软雅黑"></asp:Label>
    </div>
    <table class="table" style="border-collapse:separate; border-spacing:0px 20px; ">
            <tr class="tr1">
                <td style="width:15%;">活动名</td>
                <td style="width:22%;">活动简介</td>
            ...
            <asp:ListView ID="ListView1" runat="server">
                <ItemTemplate>                                
            <tr class="tr2">
                    <td><asp:Label ID="Label1" runat="server" Text='<%#SplitChar(Eval("Act_Title").ToString(),10) %>'></asp:Label></td> 
                    <td><asp:Label ID="AssID" runat="server" Text='<%#SplitChar(Eval("Act_Content").ToString(),10) %>'></asp:Label></td>                    
                    <td ><asp:Label ID="acttime" runat="server" Text='<%#Eval("Act_Time") %>'></asp:Label></td>               
                    <td>
